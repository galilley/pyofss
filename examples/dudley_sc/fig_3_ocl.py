...
import sys
import numpy as np
from pyofss import Domain, System, Sech, OpenclFibre
...
system.add(OpenclFibre(name='fibre', length=length, gamma=gamma, beta=beta, self_steepening=tau_shock, use_all='hollenbeck',
                 total_steps=1000, traces=300, method='ACL_RK4IP', local_error=0.001))
system.run()


storage = system['fibre'].storage  # TODO use stepper
